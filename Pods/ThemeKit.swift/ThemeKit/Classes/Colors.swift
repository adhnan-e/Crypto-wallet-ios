...
extension UIColor {
    public static let themeYellowD = UIColor(hex: 240116)
    public static let themeYellowL = UIColor(hex: 361446)
    public static let themeGreenD = UIColor(hex: 292267)
    ...
    public static let themeYellow50 = UIColor(hex: 240116, alpha: 0.5)
...
extension UIColor {
    public static var themeBackgroundFromGradient: UIColor { .themeWhite50 }
    public static var themeBackgroundToGradient: UIColor { .themeWhite50 }
