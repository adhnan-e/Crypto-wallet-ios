...
struct MainModule {
    ...
    private static var swapNavigation: UIViewController {
     
     ThemeNavigationController(rootViewController: WebViewController())
    
    }
    
    private static var buyNavigation: UIViewController {
     
     ThemeNavigationController(rootViewController: BuyViewController())
